...
fix: Replaced deleteAllPending with deleteAllForRegeneration (status-agnostic DELETE) in plan 41-02. All reminders cleared regardless of status on regeneration.
verification: Test "deletes sent reminders during regeneration" passes. Full suite 247 tests pass.
files_changed: [src/reminders/repository.ts, src/reminders/generator.ts, tests/reminders/generator.test.ts]
