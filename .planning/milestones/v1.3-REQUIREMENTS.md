# Requirements Archive: v1.3 AI Polish & UX
...
- [x] **GROC-01**: Sous saves grocery store preferences and factors them into list generation (store-specific grouping, availability awareness)
- [x] **GROC-02**: "Done shopping" button removed from grocery list messages entirely

### Mini App

- [x] **MINI-01**: User can delete a recipe card from the Mini App detail view with confirmation dialog and API endpoint
- [x] **MINI-02**: User can tap a tag on a recipe card to filter the recipe list by that tag

### Fixes

- [x] **FIX-01**: Intermittent date bugs in meal plans investigated and resolved (timezone, day-of-week mapping, or system prompt date context)
- [x] **FIX-02**: Start cooking reminder accounts for prep time, not just cook time

### Onboarding

- [x] **ONBR-01**: Onboarding flow actively pushes users to add their existing go-to meals first, making the first meal plan recipe-driven rather than open-ended
...
| GROC-01 | Phase 22 | Complete |
| GROC-02 | Phase 22 | Complete |
| MINI-01 | Phase 23 | Complete |
| MINI-02 | Phase 23 | Complete |
| ONBR-01 | Phase 24 | Complete |
